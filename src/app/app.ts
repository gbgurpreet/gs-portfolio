...
export class App {
  ...
  protected readonly profile = {
    name: 'Gurpreet Singh',
    title: 'Lead Engineer',
    subtitle: 'Lead Engineer building AI-powered full-stack products',
  ...
  protected readonly expertise = [
    'Angular (v12-v20), HTML5, CSS3, JavaScript, Bootstrap, Ionic, jQuery',
  ...
  protected readonly experience: ExperienceGroup[] = [
    {
      company: 'Niwi.ai',
      ...
      positions: [
        {
          ...
          achievements: [
            'Promoted from Senior Software Engineer to Lead Engineer on April 1, 2026.',
            'Guiding Angular and PHP delivery across nutrition SaaS products and internal platforms.',
            'Mentoring junior engineers and improving code quality through reviews and migration guidance.'
          ]
        },
        {
          ...
          location: 'Ludhiana, Punjab, India',
          summary:
            'Built production web applications and AI-assisted nutrition workflows for dietitian and client operations.',
          achievements: [
